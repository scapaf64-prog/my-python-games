...
import random
import os
import digit_animation  # Lädt dein Ziffern-Modul
...
try:
    ...
    line_clear_sound.set_volume(0.3)
except:
    line_clear_sound = None

# try:
#     line_fall_sound = pygame.mixer.Sound(os.path.join(BASE, "fall.wav"))
#     line_fall_sound.set_volume(4.0)
# except:
#     line_fall_sound = None
...
# ============================================================
# CONFIG für RollDigit und ROllNumber
# ============================================================
FONT_NAME = "Arial"
FONT_SIZE = 38  # Perfekt abgestimmt auf die linke Seitenleiste
...
class RollDigit:
    ...
    def update(self, dt):
        ...
        # ----------------------------------------
        # Tick-Sound (Optimiert mit eigenem Kanal)
        # ----------------------------------------
        prev = int(old_pos)
        curr = int(self.pos)
        ...
        while curr > prev:
            prev += 1
            if ENABLE_TICK_SOUND and self.tick:
                # find_channel(True) sucht automatisch eine freie Tonspur, 
                # damit der whoosh.mp3 Sound nicht abgebrochen wird!
...
class RollNumber:
    ...
    def set_value(self, value, extra_turns=0):
        ...
        for i, ch in enumerate(text):
            ...
            # Nutzt deine exakten Zusatzdrehungen plus den extra_turns-Parameter
            self.items[i].set_digit(digit, turns + extra_turns)

    def update(self, dt):
        # Wandelt Tetris-Millisekunden automatisch in Sekunden um
        if dt > 1.0:
            dt /= 1000.0
        for d in self.items:
            d.update(dt)
...
class Tetris:
    ...
    def reset_game(self):
        ...
        # === ROLLNUMBER INITIALISIEREN ===
        left_x = 20
        self.score_display = digit_animation.RollNumber(left_x, 50, 6, color=(210, 235, 255))
        self.level_display = digit_animation.RollNumber(left_x, 165, 2, color=(170, 205, 240))
        self.lines_display = digit_animation.RollNumber(left_x, 280, 3, color=(120, 165, 210))
    ...
    def update_animation(self, dt):
        ...
        # ============================================================
        # Punkte & Animation pro Zeile berechnen
        # ============================================================
        ...
        # Zeile physisch löschen (behoben!)
        ...
        if self.lines_to_clear:
            ...
            # Sound auf ungenutztem Kanal abspielen
            if line_clear_sound:
                ch = pygame.mixer.find_channel(True)
                if ch:
                    ch.play(line_clear_sound)
        ...
        # ============================================================
        # ENDE DER ANIMATION (Alle Zeilen durch)
        # ============================================================
