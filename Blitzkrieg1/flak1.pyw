...
try:
    flieger_sound = pygame.mixer.Sound("flugzeug2.mp3")
    flieger_sound.set_volume(1.0)
except:
    flieger_sound = None
try:
    mg_sound = pygame.mixer.Sound("return-fire2.mp3")
...
def start_plane_attack():
    ...
    global game_mode
    global attack_shadow_y
    global attack_from_left

    global attack_burst_active
    global attack_shoot_timer
    global attack_shots_remaining
    global attack_shadow_active

    global attack_finished
    global attack_end_timer
...
while running:
    ...
    if planes_passed == 4:
        ...
        if blink:
            ...
            size = 160 + int(
                math.sin(pygame.time.get_ticks() * 0.01) * 15
            )
