...
# ==========================================================
# Wuchtiger Kanonensound
# ==========================================================

# def create_cannon_sound():
...
#        low = math.sin(2 * math.pi * 40 * t)
#        sub = math.sin(2 * math.pi * 18 * t) * 0.6
#        noise = random.uniform(-1,1) * 0.4

#        envelope = math.exp(-7 * t)

#        sample = int(28000 * (low + sub + noise) * envelope)
...
# shot_sound = create_cannon_sound()
